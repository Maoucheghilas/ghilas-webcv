...
`,
  ...
  <div class="mission-block">
    ...
    <ul>
      <li>Déploiement et administration d’un cluster <strong>Kubernetes</strong> (GKE, EKS, on-premise).</li>
      ...
      <li>Services autour de Kubernetes : <strong>observabilité</strong>, <strong>sécurité (OPA/Gatekeeper)</strong>, <strong>stockage (Longhorn, EBS)</strong>.</li>
  ...
  <div class="mission-block">
    ...
    <ul>
      <li>Développement d’une marketplace en <strong>Spring Boot</strong> (Java) et <strong>React.js</strong>.</li>
  ...
  <div class="mission-block">
    <h3>🔐 Sécurité Applicative (DevSecOps)</h3>
    <ul>
      <li>Implémentation d’une authentification sécurisée avec <strong>2FA</strong> et <strong>SSO</strong>.</li>
      <li>Intégration de <strong>OAuth2/OpenID Connect</strong> via <strong>Keycloak</strong>, <strong>Auth0</strong>, <strong>Spring Security</strong>.</li>
  ...
  <div class="mission-block">
    ...
    <ul>
      <li>Développement d’un chatbot métier pour une compagnie d’assurance.</li>
  ...
  <ul>
    ...
    <li>Gestion des formats de données volumineux : <strong>Parquet</strong>, <strong>Avro</strong>, <strong>ORC</strong>, et ingestion via <strong>Kafka Connect</strong> ou <strong>NiFi</strong>.</li>
